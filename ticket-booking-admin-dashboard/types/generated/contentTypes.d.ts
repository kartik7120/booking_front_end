...
export interface ApiMovieMovie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'TWO_D'>;
    posterURL: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMovietimeslotMovietimeslot
  extends Struct.CollectionTypeSchema {
  collectionName: 'movietimeslots';
  info: {
    displayName: 'movietimeslot';
    pluralName: 'movietimeslots';
    singularName: 'movietimeslot';
  };
  options: {
    comment: '';
    draftAndPublish: false;
...
export interface ApiSeatSeat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    seatid: Schema.Attribute.UID;
    seatNumber: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['XL', 'LOWER', 'UPPER']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    venueid: Schema.Attribute.Relation<'manyToOne', 'api::venue.venue'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::movietimeslot.movietimeslot': ApiMovietimeslotMovietimeslot;
